    ...
    <Box sx={{ p: 3 }}>
      ...
      <Stack direction="row" spacing={2} sx={{ mb: 3 }}>
        <StatsCard 
          title="Total Toilets"
          value="2,456"
          icon={<ToiletIcon sx={{ color: '#2196F3' }} />}
        />
        <StatsCard 
          title="Maintained Toilets"
          value="1,890"
          icon={<BuildIcon sx={{ color: '#4CAF50' }} />}
        />
        <StatsCard 
          title="Handwashing Facilities"
          value="78%"
          icon={<SanitizerIcon sx={{ color: '#9C27B0' }} />}
        />
        <StatsCard 
                    ...
                    <TableCell>
                      <Box
                        sx={{
                          ...
                          py: 0.5,
                          borderRadius: 1,
                          bgcolor: row.status === 'Good' ? 'success.light' : 'warning.light',
                          color: row.status === 'Good' ? 'success.dark' : 'warning.dark',
                        }}
                      >
                        {row.status}
                      </Box>
